...
$id=$_GET['id'];
$res=mysql_query("SELECT * FROM hotel WHERE ID='".$id."'");
...
<!--End-Chart-box--> 
    ...
    <div class="span6">
     ...
     <div class="widget-box">
        <div class="widget-title" style="background-color: blue; color: #fff"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5 style="color: #fff">Hotel Update</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="up_hotel.php?id=<?php echo$id; ?>"  method="POST" class="form-horizontal">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                 <select name="city">
                   ...
                   <?php
                    $res1=mysql_query("SELECT * FROM city ORDER BY City_Name ASC");
                    while($row1=mysql_fetch_row($res1))
                    {
                      if($row1[0]==$row[8])
                      {
                       echo'
                        <option selected value="'.$row1[0].'">'.$row1[1].'</option>
                      '; 
                      }
                      else
                      {
            ...
            <div class="control-group">
              ...
              <div class="controls">
                 <textarea name="hotel_address"><?php echo$row[2]; ?></textarea>
            </div>
           
            <div class="control-group">
              <label for="normal" class="control-label">Owner name</label>
              <div class="controls">
                  <input type="text" name="owner_name" value="<?php echo$row[3]; ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input type="number" name="owner_mobile" value="<?php echo$row[4]; ?>">
            </div>
            </div>
...
if(isset($_POST['save']))
{
  ...
  if($res=mysql_query("UPDATE hotel SET hotel_name='".$name."',hotel_address='".$hotel_address."',owner_name='".$owner_name."',owner_mobile='".$owner_mobile."',CITY='".$city."' WHERE ID='".$id."'"))
  {
 echo'
  <script>
