            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">Type Name</th>
              ...
              <?php
                ...
                while($row=mysql_fetch_row($res))
                {
                  ...
                  <td>'.$a.'</td>
                  <td>'.$row[1].'</td>
                  <td style="text-align:center"><a href="up_type.php?id='.$row[0].'"><button class="btn btn-primary btn-sm">Update</button></td>
                
                <td style="text-align:center"><a href="del_type.php?id='.$row[0].'"><button class="btn btn-danger btn-sm">Delete</button></a></td>
                </tr>';
                $a++;
                }
