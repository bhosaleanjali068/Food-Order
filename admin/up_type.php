...
$id=$_GET['id'];
$res=mysql_query("SELECT * FROM type WHERE ID='".$id."'");
    ...
    <div class="span6">
     ...
     <div class="widget-box">
        <div class="widget-title" style="background-color: green; color: #fff"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5 style="color: #fff">Add Type</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="up_type.php?id=<?php echo$id; ?>" method="POST" class="form-horizontal">

           <div class="control-group">
              <label for="normal" class="control-label">Type</label>
              <div class="controls">
                <input type="text" id="mask-phone" class="span11 mask text" name="Type" value="<?php echo$row[1]; ?>">
...
<?php
  if(isset($_POST['save']))
  {
    ...
    if($res=mysql_query("UPDATE type SET NAME='".$Type."' WHERE ID='".$id."'"))
    {
      echo'
        <script>
