    ...
    <div class="span6">
     ...
     <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="add_type.php" method="POST" class="form-horizontal">

           <div class="control-group">
              <label for="normal" class="control-label">Type</label>
              <div class="controls">
                <input type="text" id="mask-phone" class="span11 mask text" name="Type">
                 </div>
            </div>
...
{
  $Type=$_POST['Type'];
  if(mysql_query("INSERT INTO type VALUES('','".$Type."','".$admin_id."')"))
  {
    echo'
  <script>
  alert("Type added");
  window.location.href="add_type.php";
  </script>
  ';
  }
}
