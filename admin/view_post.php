            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">Employee post</th>
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">update post</th>
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">delete post</th>
              ...
              <?php
                ...
                while($row=mysql_fetch_row($res))
                {
                  ...
                  <td style="text-align:center"><a href="up_post.php?id='.$row[0].'"><i class="btn btn-primary btn-sm">Update</button></td>
                
                <td style="text-align:center"><a href="del_post.php?id='.$row[0].'">
