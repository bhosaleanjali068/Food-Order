            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">Type</th>
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">Food name</th>
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">Food price</th>
                  <th style="background-color:#33ccff;color:#fff;font-size:15px">Food Image</th>
              ...
              <?php
                ...
                {
                  $row_t=mysql_fetch_row(mysql_query("SELECT * FROM type WHERE ID='".$row[1]."'"));
                  echo'<tr class="gradeX">
                  <td>'.$a.'</td>
                  <td>'.$row_t[1].'</td>
                  <td>'.$row[2].'</td>
                  <td>'.$row[3].'</td>
                  <td><img src="'.$row[4].'" style="height:200px; width:200px;"></td>
                   <td style="text-align:center"><a href="up_food.php?id='.$row[0].'"><button class="btn btn-primary btn-sm">Update</button></a></td>
                
                <td style="text-align:center"><a href="del_food.php?id='.$row[0].'">
