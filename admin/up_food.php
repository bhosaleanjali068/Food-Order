...
$id=$_GET['id'];
$res=mysql_query("SELECT * FROM food WHERE ID='".$id."'");
    ...
    <div class="span6">
     ...
     <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="up_food.php?id=<?php echo$id; ?>" method="POST" class="form-horizontal">
           ...
           <div class="control-group">
              ...
              <div class="controls">
                ...
                <option>---Select Type---</option>
                  <?php
                    $res1=mysql_query("SELECT * FROM type");
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input type="text" name="food" value="<?php echo$row[2]; ?>">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input type="number" name="price" value="<?php echo$row[3]; ?>">
              </div>
            </div>
...
<?php
  if(isset($_POST['save']))
  {
    ...
    if($res=mysql_query("UPDATE Food SET TYPE_NAME='".$type."',FOOD_NAME='".$name."',PRICE='".$price."' WHERE ID='".$id."'"))
      {
      echo'
        <script>
