...
$id=$_GET['id'];
$res=mysql_query("SELECT * FROM employee WHERE ID='".$id."'");
    ...
    <div class="span6">
     ...
     <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="emp_update.php?id=<?php echo$id; ?>" method="POST" class="form-horizontal">
           ...
           <div class="control-group">
              ...
              <div class="controls">
                ...
                <option>---Select Type---</option>
                  <?php
                    $res1=mysql_query("SELECT * FROM post");
            ...
            <div class="control-group">
              ...
              <div class="controls">
                 <textarea name="address"><?php echo $row[3] ?></textarea>
            </div>

             <div class="control-group">
              <label for="normal" class="control-label">Adhar num</label>
              <div class="controls">
                  <input type="number" name="adhar_num" value="<?php echo$row[4]; ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input type="mail" name="mail" value="<?php echo$row[5]; ?>">
            </div>
            </div>
           ...
           <div class="control-group">
              ...
              <div class="controls">
                  <input type="number" name="mobile" value="<?php echo$row[6]; ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input type="number" name="salary" value="<?php echo$row[7]; ?>">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  <input type="date" name="joining_date" value="<?php echo$row[8]; ?>">
...
<?php
  if(isset($_POST['save']))
  {
    ...
    if($res=mysql_query("UPDATE employee SET post='".$post."',name='".$name."',address='".$address."',adhar_num='".$adhar."',email_id='".$email."',mobile_num='".$mobile."',salary='".$salary."',joining_date='".$joining."' WHERE ID='".$id."'"))
