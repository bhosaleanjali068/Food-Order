    ...
    <div class="span6">
     ...
     <div class="widget-box">
        <div class="widget-title" style="background-color: green; color: #fff"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5 style="color: #fff">Add Food</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="add_food.php" method="POST" class="form-horizontal"  enctype="multipart/form-data">

           <div class="control-group">
              <label for="normal" class="control-label">Type</label>
              <div class="controls">
                <select name="type">
                <option>---Select Type---</option>
                  <?php
                    $res=mysql_query("SELECT * FROM type WHERE HOTEL_ID='".$admin_id."'");
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Food Name</label>
              <div class="controls">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Food Price</label>
              <div class="controls">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Food Image</label>
              <div class="controls">
...
$max_id=1;
 $max1=mysql_query("select MAX(ID) from food");
$max=mysql_fetch_row($max1);
      ...
      $file_exists=array("jpg","jpeg","png","gif","bmp","pdf");//file extenssions supported for upload 
        ...
        else
        {
            ...
            {
             $newname="$max_id"."_food."."png";//name of file name to be saved
  ...
  if(mysql_query("INSERT INTO food VALUES('','".$type."','".$food."','".$price."','".$targetfile."','".$admin_id."')"))
  {
    echo'
  <script>
  alert("Food added");
