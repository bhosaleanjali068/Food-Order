    ...
    <div class="span6">
     ...
     <div class="widget-box">
        <div class="widget-title" style="background-color: green; color: #fff"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5 style="color: #fff">Customer Registration</h5>
        </div>
        <div class="widget-content nopadding">
          <form action="add_Customer.php"  method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Customer Name</label>
              <div class="controls">
                  <input type="num" name="mobile">
              </div>
            </div>
            <div class="control-group">
              <label for="normal" class="control-label">Customer num</label>
              <div class="controls">
                  <input type="num" name="mobile">
              </div>
            </div>
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Customer address</label>
              <div class="controls">
                 <textarea name="add"></textarea>
            </div>
           
            <div class="control-group">
              <label for="normal" class="control-label">Customer email id</label>
              <div class="controls">
...
if(isset($_POST['save']))
{
  ...
  $Customer_name=$_POST['customer_num'];
  ...
  if(mysql_query("INSERT INTO  employee VALUES('','".$post."','".$Customer_name."','".$Customer_num."',".$Customer_adress."','".$Adhar_num."','".$Customer_email_id."','".$Mobile_num."','".$Salary."','".$Joining_date."')"))
  {
    echo'
  <script>
